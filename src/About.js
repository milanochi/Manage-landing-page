                            ...
                            <div className="container mx-auto  flex px-6 flex-col items-start space-y-0 md:space-y-0 md:flex-row">
                              ...
                              <div className="flex flex-col  space-y-8 md:w-1/2">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <p className="text-center leading-6 text-sm text-grayishBlue md:text-left md:bg-white"> Manage provides all the functionality your team needs, without 
                                                the complexity. Our software is tailor-made for modern digital 
                                                product teams.</p>
                                        </div>
                                             ...
                                             <div className="space-y-4">
                                                ...
                                                <p className="text-center text-sm leading-6 text-grayishBlue md:text-left"> Set internal delivery estimates and track progress toward company 
                                                    goals. Our customisable dashboard helps you build out the reports 
                                                    you need to keep key stakeholders informed</p>
                                             </div>
